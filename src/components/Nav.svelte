<script>
  	import Hamburger from "../utilities/Hamburger.svelte"
	import MobileMenu from "../utilities/MobileMenu.svelte"
...
<nav class="relative container mx-auto p-6">
  <div class="flex items-center justify-between">
    <div class="pt-2">
      <img src="https://raw.githubusercontent.com/35degrees/tailwind-svelte-landing-traversy/blob/main/src/images/logo.svg" alt="logo">
    </div>
